...
Update riset lanjutan: foto pengganti tujuh Blackmores dan foto 12 varian ukuran Padini (4 style) sudah disiapkan di `supabase/data/20260914_additional_variant_photos.sql`. Jalankan setelah migrasi foto; guard ID/SKU/nama dan preservasi foto existing sama seperti import Tudungruffle. Detail sumber, 108 baris foto spreadsheet, dan kandidat yang masih ditahan ada di [CATALOGUE-PHOTOS.md](CATALOGUE-PHOTOS.md). Milo/KitKat/BOH/Oriental/Beryls/Garrett/Morinaga disiapkan dalam JSON untuk dicocokkan dengan ID/SKU database staff; jangan membuat produk duplikat berdasarkan ketidakhadiran di katalog publik. Dua model Padini dengan link identik serta dua kemasan Milo perlu konfirmasi sebelum digunakan.
